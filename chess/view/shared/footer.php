<footer>
    <div class="main_footer fix bg-mega text-center p-top-40 p-bottom-30 m-top-80" style="padding-top:10px;padding-bottom:10px;">
        <!-- <div class="col-md-12">
            <p class="wow fadeInRight" data-wow-duration="1s">
                Made with
                <i class="fa fa-heart"style="color: orange;"></i>
                by
